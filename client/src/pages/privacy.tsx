  ...
  return (
    <div className={styles.privacyPolicy}>
      ...
      <p>
        ...
        безопасности персональных данных, предпринимаемые Киреева Екатерина
        (далее — Оператор).
      </p>
      <p>
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта https://capencoat.ru.
      </p>
      <h2>2. Основные понятия, используемые в Политике</h2>
      <p>
        <strong>2.1. Автоматизированная обработка персональных данных</strong> —
      ...
      <p>
        <strong>2.5. Обезличивание персональных данных</strong> — действия, в
      ...
      <p>
        <strong>2.7. Оператор</strong> — государственный орган, муниципальный
      ...
      <p>
        ...
        Пользователю веб-сайта https://capencoat.ru.
      </p>
      <p>
        <strong>
      ...
      <p>
        <strong>2.11. Предоставление персональных данных</strong> — действия,
        направленные на раскрытие персональных данных определенному лицу или
        определенному кругу лиц.
      </p>
      <p>
        <strong>2.12. Распространение персональных данных</strong> — любые
      ...
      <p>
        <strong>2.14. Уничтожение персональных данных</strong> — любые действия,
      ...
      <p>2.2 Электронный адрес</p>
      <p>2.3 Номера телефонов</p>
      <p>
        2.4 Адрес фактического места проживания и регистрации по месту
      ...
      <p>
        3.1 Договоры, заключаемые между оператором и субъектом персональных
        данных
      </p>
      <h2>7. Виды обработки персональных данных</h2>
      <p>
        <strong>
          4.1 Сбор, запись, систематизация, накопление, хранение, уничтожение и
      ...
      <p>
        ...
        уведомление на адрес электронной почты Оператора privacy@capencoat.ru с
      ...
      <p>
        ...
        электронной почты на электронный адрес Оператора privacy@capencoat.ru с
      ...
      <p>
        ...
        Оператору с помощью электронной почты privacy@capencoat.ru.
      </p>
      <p>
      ...
      <p>
        ...
        Интернет по адресу https://capencoat.ru/privacy.
      </p>
    </div>
  );
}
